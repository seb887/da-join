...
async function editSingleSubtask(taskId, index) {
  const inputEditSubtask = document.getElementById(`input-edit-subtask-${index}`);
...
function styleEditSingleSubtask(index, inputEditSubtask) {
  const singleSubtaskTitle = document.getElementById(`single-subtask-title-${index}`);
  const editSubtaskBtn = document.getElementById(`edit-subtask-${index}`);
  const submitEditSubtaskBtn = document.getElementById(`submit-edit-subtask-${index}`);
